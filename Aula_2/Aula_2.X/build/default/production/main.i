...
void main(void)
{
    ...
    INT0_InterruptHandler(pulso_encoder)
    ...
    lcd_draw_string (45,155,"XC8 - Biblioteca - LCD - ILI9341",0x001F,0x0000);

    lcd_draw_string (120,120,"PIC - SEEV",0x0400,0x0000);
...
# 85 "main.c"
    while (1)
    {
        ...
        lcd_draw_string(10,10,teste,0x0400,0x0000);
