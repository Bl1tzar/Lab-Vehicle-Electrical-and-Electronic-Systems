...
# 360 "./mcc_generated_files/eusart1.h"
void EUSART1_SetFramingErrorHandler(void (* interruptHandler)(void));
# 378 "./mcc_generated_files/eusart1.h"
...
# 78 "main.c"
    ...
    if (DATAEE_ReadByte(0x02)!=0xFF){
        turn_on_value=DATAEE_ReadByte(0x00);
        turn_off_value=DATAEE_ReadByte(0x01);
    }
    ...
    while (1) {
        ...
        lcd_draw_string(100, 100, string, 0xFFFF, 0x0000);
